...
export class SaVClock {
  ...
  static get themes () {
	  const default_t = game.system.savclocks.themes[ game.settings.get( "ziggurat", "defaultClockTheme" ) ];
  ...
  get image () {
    return {
      img: `systems/ziggurat/themes/${this.theme}/${this.size}clock_${this.progress}.webp`,
      widthTile: 200,
      heightTile: 200,
	    widthSheet: 350,
	    heightSheet: 350
